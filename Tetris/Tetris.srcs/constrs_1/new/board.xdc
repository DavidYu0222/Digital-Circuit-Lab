...
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33} [get_ports {usr_sw[0]}]
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports {usr_sw[1]}]
set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports {usr_sw[2]}]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports {usr_sw[3]}]
